...
module RedisFailover
  ...
  shared_examples "NodeManagerExample" do |node_type|
    describe NodeManager do
      let(:manager) { node_type.new({}) }
  ...
  describe 'ExecuteNodeManagerExample' do
    include_examples "NodeManagerExample", ZkNodeManagerStub
    include_examples "NodeManagerExample", EtcdNodeManagerStub
  end
end
